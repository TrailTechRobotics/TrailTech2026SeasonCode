...
public class LimelightFrontCenterAutoCommand extends Command {
  ...
  public LimelightFrontCenterAutoCommand(LimelightSubsystem ll, LimelightSubsystem ll2, DriveSubsystem m_drive/* , CommandXboxController m_controller*/) {
    this.ll = ll;
    this.ll2 = ll2;
