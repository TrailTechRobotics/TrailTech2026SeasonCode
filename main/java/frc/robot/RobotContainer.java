...
public class RobotContainer {
  ...
  private final FuelgrabberSubsystem m_fuelgrabber = new FuelgrabberSubsystem(10, 1);
  ...
  public RobotContainer() {
    //Camera Offsets
    m_limelightBack.setLLOFFSET(-0.597,0,0);
  ...
  private void configureButtonBindings() {
    ...
    m_driverController.povUp().whileTrue(new InstantCommand(() -> m_intakeModule.setIntakeModuleDown(), m_intakeModule));

    //Driver Intake Module Up
    m_driverController.povDown().whileTrue(new InstantCommand(() -> m_intakeModule.setIntakeModuleUp(), m_intakeModule));
    ...
    //Driver Hopper And Chute Forward
    ...
    .whileTrue(new RunCommand(() -> m_fuelgrabber.setScooperVelocity(-4500), m_fuelgrabber))
    .onFalse(new InstantCommand(() -> m_fuelgrabber.stopScooper(), m_fuelgrabber));
    ...
    m_copilotController.x().whileTrue(Commands.startEnd(
      ...
      m_fuelgrabber, m_chute, m_launcher, m_limelightFront, m_limelightBack
    ));

    //Copilot Full Launch System With Velocity
    m_copilotController.a().whileTrue(Commands.startEnd(
      () -> {
        m_fuelgrabber.setScooperVelocity(-4500);
        m_chute.setChuteSpeed(1);
  ...
  public Command getAutonomousCommand() {
    //try{
      ...
      //-4500, 1, 4000);
      auto1 auto = new auto1(m_intakeModule, m_fuelgrabber, m_chute, m_launcher);
      return auto;
    //} catch (Exception e) {
    //  return null;
    //}
